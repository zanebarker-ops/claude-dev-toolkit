...
4. **Determine Applicable Reviews**
   ...
   Based on changes:
   - **Always applicable**: code-reviewer (general quality + security)
...
- Checks Supabase error handling
...
- **Security first**: Always include security check for database/API changes
